    ...
    public static let all: [ShaderGradientPreset] = [
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(
                ...
                brightness: 1.2, grain: 0.2, reflection: 0.1,
        ...
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(
                ...
                brightness: 1.15, grain: 0.2, reflection: 0.12,
        ...
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(
                ...
                brightness: 1.1, grain: 0.2, reflection: 0.18,
                cPolarAngle: 90, cAzimuthAngle: 180, cDistance: 3.6, fov: 45,
        ...
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(
                ...
                brightness: 1.25, grain: 0.2, reflection: 0.08,
                cPolarAngle: 90, cAzimuthAngle: 180, cDistance: 3.6, fov: 45,
        ...
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(
                ...
                brightness: 1.1, grain: 0.2, reflection: 0.1,
        ...
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#7B2FF7"), .hex("#3A86FF"), .hex("#0A1033")],
                ...
                brightness: 1.05, grain: 0.2, reflection: 0.12, rotationZ: 50, fps: 30)),
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#FF6B6B"), .hex("#FF9E7D"), .hex("#FFD6A5")],
                ...
                brightness: 1.08, grain: 0.2, reflection: 0.1, rotationZ: 45, fps: 30)),
        ShaderGradientPreset(
            id: "mint3d", name: "Mint",
            config: ShaderGradientConfig(colors: [.hex("#22E0A1"), .hex("#1BC7C7"), .hex("#0B5E5E")],
                ...
                brightness: 1.05, grain: 0.2, reflection: 0.16, rotationZ: 35, fps: 30)),
        ShaderGradientPreset(
            id: "plum3d", name: "Plum",
            config: ShaderGradientConfig(colors: [.hex("#2A0A4A"), .hex("#A8327D"), .hex("#FF6EC7")],
                ...
                brightness: 1.0, grain: 0.2, reflection: 0.12, rotationZ: 55, fps: 30)),
        ShaderGradientPreset(
            id: "gold3d", name: "Gold",
            config: ShaderGradientConfig(colors: [.hex("#FFC83D"), .hex("#FF8A00"), .hex("#5A2B00")],
                ...
                brightness: 1.06, grain: 0.2, reflection: 0.12, rotationZ: 48, fps: 30)),
        ShaderGradientPreset(
            id: "sky3d", name: "Sky",
            config: ShaderGradientConfig(colors: [.hex("#56CCF2"), .hex("#A0E9FF"), .hex("#E8F7FF")],
                ...
                brightness: 1.1, grain: 0.2, reflection: 0.1, rotationZ: 40, fps: 30)),
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#0077B6"), .hex("#00B4D8"), .hex("#03045E")],
                ...
                brightness: 1.0, grain: 0.2, reflection: 0.2, rotationZ: 30, fps: 30)),
        ShaderGradientPreset(
            id: "rose3d", name: "Rose",
            config: ShaderGradientConfig(colors: [.hex("#FF8FB1"), .hex("#FFC2D1"), .hex("#FFE5EC")],
                type: .plane, speed: 0.2, density: 1.3, frequency: 5.0, amplitude: 1.0, strength: 2.6,
                brightness: 1.1, grain: 0.2, reflection: 0.08, rotationZ: 52, fps: 30)),
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#3A0CA3"), .hex("#7209B7"), .hex("#03010F")],
                ...
                brightness: 1.0, grain: 0.2, reflection: 0.15, rotationZ: 40, fps: 30)),
        ShaderGradientPreset(
            id: "lava3d", name: "Lava",
            config: ShaderGradientConfig(colors: [.hex("#FF1E00"), .hex("#FF7A00"), .hex("#1A0300")],
                ...
                brightness: 1.05, grain: 0.2, reflection: 0.1, rotationZ: 42, fps: 30)),
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#FFB997"), .hex("#FFD6BA"), .hex("#F7B2C4")],
                ...
                brightness: 1.08, grain: 0.2, reflection: 0.1, rotationZ: 50, fps: 30)),
        ShaderGradientPreset(
            ...
            config: ShaderGradientConfig(colors: [.hex("#8095A8"), .hex("#B7C4CF"), .hex("#2B3A45")],
                ...
                brightness: 1.0, grain: 0.2, reflection: 0.18, rotationZ: 46, fps: 30)),
        ShaderGradientPreset(
            id: "neon3d", name: "Neon",
            config: ShaderGradientConfig(colors: [.hex("#00F5D4"), .hex("#F15BB5"), .hex("#9B5DE5")],
                ...
                brightness: 1.08, grain: 0.2, reflection: 0.14, rotationZ: 55, fps: 30)),
        ShaderGradientPreset(
            id: "ember3d", name: "Ember 3D",
            config: ShaderGradientConfig(colors: [.hex("#3A0A00"), .hex("#FF6B00"), .hex("#FFD08A")],
                type: .plane, speed: 0.2, density: 1.4, frequency: 5.0, amplitude: 1.0, strength: 3.4,
                brightness: 1.05, grain: 0.2, reflection: 0.1, rotationZ: 44, fps: 30)),
    ]
