...
public struct GradientPreset: Identifiable, Hashable, Sendable {
    ...
    public func makeItem() -> ContentItem {
        ContentItem.gradient(config, name: name, author: "Haze")
    }
}
    ...
    public static let all: [GradientPreset] = [
        GradientPreset(
            ...
            config: GradientConfig(
                ...
                speed: 0.2, grain: 0.44, warp: 1.1, brightness: 1.05, style: .halo, fps: 30)),
        GradientPreset(
            id: "aurora",
            name: "Aurora",
            config: GradientConfig(
                colors: [.hex("#00C2A8"), .hex("#1E5AFF"), .hex("#7A2BFF"), .hex("#10183A")],
                speed: 0.2, grain: 0.44, warp: 0.9, brightness: 1.0, style: .aurora, fps: 30)),
        GradientPreset(
            id: "sunset",
            name: "Sunset",
            config: GradientConfig(
                colors: [.hex("#FFB03A"), .hex("#FF5E62"), .hex("#A33A9E"), .hex("#2B1055")],
                speed: 0.2, grain: 0.44, warp: 1.0, brightness: 1.02, style: .aurora, fps: 30)),
        GradientPreset(
            id: "lagoon",
            name: "Lagoon",
            config: GradientConfig(
                colors: [.hex("#0FF0B3"), .hex("#0AA6D6"), .hex("#0B3B6F"), .hex("#06122A")],
                speed: 0.2, grain: 0.44, warp: 1.3, brightness: 0.98, style: .liquid, fps: 30)),
        GradientPreset(
            id: "ember",
            name: "Ember",
            config: GradientConfig(
                colors: [.hex("#FF2E00"), .hex("#FF8A00"), .hex("#3A0A00")],
                speed: 0.2, grain: 0.44, warp: 1.4, brightness: 1.0, style: .liquid, fps: 30)),
        GradientPreset(
            id: "mono-noir",
            name: "Noir",
            config: GradientConfig(
                colors: [.hex("#1A1A1F"), .hex("#3A3A45"), .hex("#0A0A0C")],
                speed: 0.2, grain: 0.44, warp: 0.7, brightness: 0.9, style: .aurora, fps: 24)),
        GradientPreset(
            id: "cotton",
            name: "Cotton",
            config: GradientConfig(
                colors: [.hex("#FFD3E0"), .hex("#C9E4FF"), .hex("#E4D3FF"), .hex("#FFF6E6")],
                speed: 0.2, grain: 0.44, warp: 0.85, brightness: 1.08, style: .aurora, fps: 30)),
        GradientPreset(
            id: "nebula",
            name: "Nebula",
            config: GradientConfig(
                colors: [.hex("#5B2A86"), .hex("#0E4D92"), .hex("#C2407E"), .hex("#05010F")],
                speed: 0.2, grain: 0.44, warp: 1.5, brightness: 1.0, style: .halo, fps: 30)),
    ]
