...
struct ScreensaverSettingsView: View {
    ...
    private var notInstalledCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("macOS controls when the screensaver starts. Install it here, then choose “HazeSaver” and set the idle timer in System Settings.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
            HStack {
    ...
    private func install() {
        ...
        statusMessage = ok
            ? "Installed. Select “HazeSaver” in Screen Saver settings."
